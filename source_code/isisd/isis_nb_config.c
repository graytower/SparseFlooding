 ...
 */
int lib_interface_isis_no_flood_modify(struct nb_cb_modify_args *args)
{
    struct isis_circuit *circuit;
    bool no_flood = yang_dnode_get_bool(args->dnode, NULL);
    ...
    /* 这里直接设置你在 struct isis_circuit 里的标志位 */
    circuit->flood_control = no_flood;
